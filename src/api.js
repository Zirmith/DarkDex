                    ...
                    <div class="move-details-content">
                        <div class="move-details-header">
                            ...
                            <button class="close-move-details">
                                ...
                                // Add remaining moves without details
                                if (details.moves.length > 30) {
                                    detailedMoves.push(...details.moves.slice(30));
                                }
                            </button>
                        </div>
                        ...
                        let cryUrl = null;
                        try {
                            // Use the official Pokemon cries from PokeAPI
                            cryUrl = `https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/${details.id}.ogg`;
                        } catch (error) {
                            console.warn(`Could not get cry URL for ${pokemon.name}:`, error);
                        }
                        ...
                        try {
                            ...
                            // Use default cry URL
                                ...
                                <div class="move-stat">
                            detailedMoves: detailedMoves || details.moves || [],
